...
export let Slider = ({image}) => {


    return (
        <div className="w-[640px] md:w-[768px] lg:w-[1024px] h-[407px] md:h-[488px] lg:h-[650px] max-sm:hidden">
            <div className="w-[640px] md:w-[768px] lg:w-[1024px] relative">
                <Image image={image} type={false}/>
            </div>
        </div>
    )
...
//     <div className="max-sm:hidden w-[640px] md:w-[768px] lg:w-[1024px] xl:[1200px]  mx-auto">
