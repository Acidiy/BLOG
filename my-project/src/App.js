import { Card, Demo, Post, Slider } from "./components"
  ...
  return (
    ...
    <div className="flex flex-col gap-24 my-24">
      ...
      <div className="w-[640px] md:w-[768px] lg:w-[1024px] flex overflow-scroll mx-auto">
        <div className="w-full"><Slider image={DATA.slider_image_data[0]} date={DATA.date} topics={DATA.tags.tech}/></div>
        <div className="w-full"><Slider image={DATA.slider_image_data[1]} date={DATA.date} topics={DATA.tags.tech}/></div>
        <div className="w-full"><Slider image={DATA.slider_image_data[2]} date={DATA.date} topics={DATA.tags.tech}/></div>
      </div>
      ...
      <div className=" w-[600px] md:w-[920px] lg:w-[1220px] xl:[1400px] flex flex-col mx-auto">
        ...
        <div className="w-[600px] md:w-[920px] lg:w-[1220px] xl:[1400px] flex gap-5 overflow-scroll">
          <Card image_index={0} topics={DATA.tags.politics} tag_type={true} headline_type={true} content={DATA.headline} />
          <Card image_index={1} topics={DATA.tags.politics} tag_type={true} headline_type={true} content={DATA.headline} />
          <Card image_index={2} topics={DATA.tags.politics} tag_type={true} headline_type={true} content={DATA.headline} />
          <Card image_index={3} topics={DATA.tags.politics} tag_type={true} headline_type={true} content={DATA.headline} />
          <Card image_index={0} topics={DATA.tags.politics} tag_type={true} headline_type={true} content={DATA.headline} />
          <Card image_index={1} topics={DATA.tags.politics} tag_type={true} headline_type={true} content={DATA.headline} />
          <Card image_index={2} topics={DATA.tags.politics} tag_type={true} headline_type={true} content={DATA.headline} />
          <Card image_index={3} topics={DATA.tags.politics} tag_type={true} headline_type={true} content={DATA.headline} />
